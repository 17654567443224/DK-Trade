...
/**
 * 开仓策略对象 strategy_open_position
 * 
 * @author ruoyi
 * @date 2025-02-27
 */
@ApiModel(description = "开仓策略")
public class StrategyOpenPosition extends BaseEntity
{
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("openPositionName", getOpenPositionName())
