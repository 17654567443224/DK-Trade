<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="最多持仓" prop="maxPosition">
        <el-input
          v-model="queryParams.maxPosition"
          placeholder="请输入最多持仓"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="strategyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="本金" align="center" prop="account" />
      <el-table-column label="最多持仓" align="center" prop="maxPosition" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="最多持仓" prop="maxPosition">
          <el-input v-model="form.maxPosition" placeholder="请输入最多持仓" />
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        maxPosition: [
          { required: true, message: "最多持仓不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除策略模板编号为"' + ids + '"的数据项？').then(function() {
