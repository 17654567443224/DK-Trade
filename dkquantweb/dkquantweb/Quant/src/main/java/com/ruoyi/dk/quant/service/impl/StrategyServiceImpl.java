...
public class StrategyServiceImpl implements IStrategyService 
{
    ...
    public String addStrategy(StrategyBO strategyBO) throws JsonProcessingException {
        ...
        if (openPositionId != null){
            FunctionOpenPosition functionOpenPosition = functionOpenPositionService.selectFunctionOpenPositionById(openPositionId);
            funMap.put("open_position", functionOpenPosition);
        }
