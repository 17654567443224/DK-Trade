...
if __name__ == '__main__':
    ...
    # 查看历史持仓信息
    # result = accountAPI.get_positions_history(instType = '', instId = '', mgnMode = '', type = '', after = '', before = '', limit = '', posId = '')
    ...
    # 获取交易对的标记价格
    # result = publicAPI.get_mark_price()
    ...
    # trading data
    tradingDataAPI = TradingData.TradingDataAPI()
    ...
    # result = tradeAPI.get_orders('THETA-USDT-SWAP', '1801978201804242944')
    ...
    # FDBrokerAPI
    FDBrokerAPI = FDBroker.FDBrokerAPI()
    # 生成返佣明细下载链接
    ...
    # 网格交易
    TradingBot = TradingBot.TradingBotAPI()
    # 网格策略下单
    ...
    Copytrading = Copytrading.CopytradingAPI()
    # 交易员获取当前带单
    ...
    # 定投
    Recurring = Recurring.RecurringAPI()
    # 定投策略委托下单
    ...
    # from functionns.Common import deal_message
