...
class websocket_funs:
    ...
    def get_position_tiers(self, symbol, lever, usdt, price, ctVal, tradingview, minSz):
        switch = True
        while switch == True:
            try:
                switch = False
    ...
    def trade_logic(self, trading_view, bv, lever, symbol, price, ba, ctVal, avg_val,
                    algo, minSz):  # trade_logic  tradingview, bv, lever, symbol, price, ba, ctVal
        ...
        if usdt > ba * Decimal(setting.proportion):
            ...
            return
        sz = self.get_position_tiers(symbol, lever, usdt, price, ctVal, trading_view, minSz)
    ...
    def trading(self, tradingview, symbol, price, ts):  # 1.get_banlance  2.get_max_lever and position_cont(usdt)
        ...
        self.trade_logic(tradingview, bv, lever, symbol, price, ba, ctVal, avg_val, algo, minSz)
