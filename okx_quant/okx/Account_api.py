...
class AccountAPI(Client):
    ...
    def get_bills_detail(self, instType='', instId='', ccy='', mgnMode='', ctType='', type='', subType='', after='',
                         before='', begin='', end='',
                         limit=''):
        params = {'instType': instType, 'ccy': ccy, 'mgnMode': mgnMode, 'ctType': ctType, 'type': type,
                  'subType': subType, 'after': after, 'before': before, 'limit': limit, 'instId': instId,
                  'begin': begin, 'end': end}
        return self._request_with_params(GET, BILLS_DETAIL, params)

    # Get Bills Details (recent 3 months)
    def get_bills_details(self, instType='', instId='', ccy='', mgnMode='', ctType='', type='', subType='',
    ...
    def get_fee_rates(self, instType='', instId='', uly='', category='', instFamily='', ruleType=''):
        params = {'instType': instType, 'instId': instId, 'uly': uly, 'category': category,
                  'instFamily': instFamily, 'ruleType': ruleType}
    ...
    def get_interest_accrued(self, instId='', ccy='', mgnMode='', after='', before='', limit='', type=''):
        params = {'instId': instId, 'ccy': ccy, 'mgnMode': mgnMode, 'after': after, 'before': before,
    ...
    def get_simulated_margin(self, instType='', inclRealPos='', spotOffsetType='', simPos=[]):
        params = {'instType': instType, 'inclRealPos': inclRealPos, 'spotOffsetType': spotOffsetType,
                  'simPos': simPos}
    ...
    def get_positions_history(self, instType='', instId='', mgnMode='', type='', after='', before='', limit='',
                              posId=''):
        params = {'instType': instType, 'instId': instId, 'mgnMode': mgnMode, 'type': type, 'after': after,
                  'before': before, 'limit': limit, 'posId': posId}
    ...
    def quick_margin_borrow_repay_history(self, instId='', ccy='', side='', after='', before='', begin='', end='',
                                          limit=''):
        params = {'instId': instId, 'ccy': ccy, 'side': side, 'after': after, 'before': before, 'begin': begin,
                  'end': end, 'limit': limit}
    ...
    def mmp_config(self, instFamily, timeInterval, frozenInterval, qtyLimit):
        params = {'instFamily': instFamily, 'timeInterval': timeInterval, 'frozenInterval': frozenInterval,
                  'qtyLimit': qtyLimit, }
    ...
    def get_fixed_loan_borrowing_quote(self, type='', ccy='', amt='', maxRate='', term='', ordId=''):
        params = {'type': type, 'ccy': ccy, 'amt': amt, 'maxRate': maxRate, 'maxRate': maxRate, 'term': term,
                  'ordId': ordId}
    ...
    def fixed_loan_borrowing_order(self, ccy='', amt='', maxRate='', term='', reborrow='', reborrowRate=''):
        params = {'ccy': ccy, 'amt': amt, 'maxRate': maxRate, 'term': term, 'reborrow': reborrow,
