...
class TradeAPI(Client):
    ...
    def place_order(self, instId, tdMode, side, ordType, sz, ccy='', clOrdId='', tag='', posSide='', px='',
                    ...
                    slTriggerPx='', slOrdPx='', tpTriggerPxType='', slTriggerPxType='', stpId='',tpOrdKind='',
                    stpMode='', attachAlgoClOrdId=''):
        params = {'instId': instId, 'tdMode': tdMode, 'side': side, 'ordType': ordType, 'sz': sz, 'ccy': ccy,
                  'clOrdId': clOrdId, 'tag': tag, 'posSide': posSide, 'px': px, 'reduceOnly': reduceOnly,
                  'tgtCcy': tgtCcy, 'banAmend': banAmend, 'quickMgnType': quickMgnType, 'tpTriggerPx': tpTriggerPx,
                  'tpOrdKind': tpOrdKind,'tpOrdPx': tpOrdPx, 'slTriggerPx': slTriggerPx
    ...
    def get_orders_history(self, instType='', uly='', instId='', ordType='', state='', after='', before='',
                           limit='', instFamily='', category='', begin='', end=''):
        params = {'instType': instType, 'uly': uly, 'instId': instId, 'ordType': ordType, 'state': state,
                  'after': after, 'before': before, 'limit': limit, 'instFamily': instFamily, 'category': category,
                  'begin': begin, 'end': end}
        return self._request_with_params(GET, ORDERS_HISTORY, params)

    # Get Order History (last 3 months)
    def orders_history_archive(self, instType, uly='', instId='', ordType='', state='', after='', before='',
                               limit='', instFamily='', category='', begin='', end=''):
        params = {'instType': instType, 'uly': uly, 'instId': instId, 'ordType': ordType, 'state': state,
                  'after': after, 'before': before, 'limit': limit, 'instFamily': instFamily, 'category': category,
                  'begin': begin, 'end': end}
    ...
    def get_fills(self, instType='', uly='', instId='', ordId='', after='', before='',
        ...
        params = {'instType': instType, 'uly': uly, 'instId': instId, 'ordId': ordId, 'after': after,
                  'before': before,
    ...
    def place_algo_order(self, instId='', tdMode='', side='', ordType='', sz='', ccy='',
        ...
        params = {'instId': instId, 'tdMode': tdMode, 'side': side, 'ordType': ordType, 'sz': sz, 'ccy': ccy,
                  ...
                  'tag': tag, 'triggerPxType': triggerPxType, 'algoClOrdId': algoClOrdId,
    ...
    def order_algos_history(self, ordType, state='', algoId='', instType='', instId='', after='', before='',
                            limit=''):
